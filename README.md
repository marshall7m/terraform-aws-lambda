...
| <a name="input_destination_config"></a> [destination\_config](#input\_destination\_config) | AWS ARNs of services that will be invoked if Lambda function succeeds or fails | <pre>object({<br>    success = optional(string)<br>    failure = optional(string)<br>  })</pre> | `null` | no |
